...
# For Eric's machine
# filePath <- "D:/EDM_LT/GitHub/LTIMP_TA/LTIMP_TA2/EGRET/UT5/"
...
write.table(localAnnualResults, file = 'UT5_NO3_RawVals.txt', quote=FALSE, row.names=FALSE)
...
plotConcHist(eList, plotFlowNorm=TRUE, tinyPlot=TRUE,concMax = 0.08,yearEnd = 2015)
dev.off()


plotConcHist(eList, plotFlowNorm=TRUE, concMax=0.09, printTitle=FALSE)
...
OP_changepoint <- read.table ("/Users/joed/LTIMP_TA/LTIMP_TA2/EGRET/UT5/OP/EGRET_plots/UT5_OP_RawVals.txt",header = TRUE)
...
tiff("/Users/joed/LTIMP_TA/LTIMP_TA2/EGRET/UT5/OP/EGRET_plots/UT5_OP_Changepoint",height = 700, width = 1200, res=120)
...
localAnnualResults <- setupYears(paStart = paStart, paLong = paLong, localDaily = localDaily)
write.table(localAnnualResults, file = 'UT5_TKN_RawVals.txt', quote=FALSE, row.names=FALSE)
...
early_jan <- subset(early_decade_monthly_mn, month==1)
recent_jan <- subset(recent_decade_monthly_mn, month==1)
UT5_TKN_conc_jan_wilcox <- wilcox.test(recent_jan$ConcDay, early_jan$ConcDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

early_feb <- subset(early_decade_monthly_mn, month==2)
recent_feb <- subset(recent_decade_monthly_mn, month==2)
UT5_TKN_conc_feb_wilcox <- wilcox.test(recent_feb$ConcDay, early_feb$ConcDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

early_mar <- subset(early_decade_monthly_mn, month==3)
recent_mar <- subset(recent_decade_monthly_mn, month==3)
UT5_TKN_conc_mar_wilcox <- wilcox.test(recent_mar$ConcDay, early_mar$ConcDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

early_apr <- subset(early_decade_monthly_mn, month==4)
recent_apr <- subset(recent_decade_monthly_mn, month==4)
UT5_TKN_conc_apr_wilcox <- wilcox.test(recent_apr$ConcDay, early_apr$ConcDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

early_may <- subset(early_decade_monthly_mn, month==5)
recent_may <- subset(recent_decade_monthly_mn, month==5)
UT5_TKN_conc_may_wilcox <- wilcox.test(recent_may$ConcDay, early_may$ConcDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

early_jun <- subset(early_decade_monthly_mn, month==6)
recent_jun <- subset(recent_decade_monthly_mn, month==6)
UT5_TKN_conc_jun_wilcox <- wilcox.test(recent_jun$ConcDay, early_jun$ConcDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

early_jul <- subset(early_decade_monthly_mn, month==7)
recent_jul <- subset(recent_decade_monthly_mn, month==7)
UT5_TKN_conc_jul_wilcox <- wilcox.test(recent_jul$ConcDay, early_jul$ConcDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

early_aug <- subset(early_decade_monthly_mn, month==8)
recent_aug <- subset(recent_decade_monthly_mn, month==8)
UT5_TKN_conc_aug_wilcox <- wilcox.test(recent_aug$ConcDay, early_aug$ConcDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

early_sep <- subset(early_decade_monthly_mn, month==9)
recent_sep <- subset(recent_decade_monthly_mn, month==9)
UT5_TKN_conc_sep_wilcox <- wilcox.test(recent_sep$ConcDay, early_sep$ConcDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

early_oct <- subset(early_decade_monthly_mn, month==10)
recent_oct <- subset(recent_decade_monthly_mn, month==10)
UT5_TKN_conc_oct_wilcox <- wilcox.test(recent_oct$ConcDay, early_oct$ConcDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

early_nov <- subset(early_decade_monthly_mn, month==11)
recent_nov <- subset(recent_decade_monthly_mn, month==11)
UT5_TKN_conc_nov_wilcox <- wilcox.test(recent_nov$ConcDay, early_nov$ConcDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

early_dec <- subset(early_decade_monthly_mn, month==12)
recent_dec <- subset(recent_decade_monthly_mn, month==12)
UT5_TKN_conc_dec_wilcox <- wilcox.test(recent_dec$ConcDay, early_dec$ConcDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

Conc_compare <- data.frame(chng_est=c(UT5_TKN_conc_oct_wilcox$est,
                                      UT5_TKN_conc_nov_wilcox$est,
                                      UT5_TKN_conc_dec_wilcox$est,
                                      UT5_TKN_conc_jan_wilcox$est,
                                      UT5_TKN_conc_feb_wilcox$est,
                                      UT5_TKN_conc_mar_wilcox$est,
                                      UT5_TKN_conc_apr_wilcox$est,
                                      UT5_TKN_conc_may_wilcox$est,
                                      UT5_TKN_conc_jun_wilcox$est,
                                      UT5_TKN_conc_jul_wilcox$est,
                                      UT5_TKN_conc_aug_wilcox$est,
                                      UT5_TKN_conc_sep_wilcox$est),
                           low_conf=c(UT5_TKN_conc_oct_wilcox$conf.int[1],
                                      UT5_TKN_conc_nov_wilcox$conf.int[1],
                                      UT5_TKN_conc_dec_wilcox$conf.int[1],
                                      UT5_TKN_conc_jan_wilcox$conf.int[1],
                                      UT5_TKN_conc_feb_wilcox$conf.int[1],
                                      UT5_TKN_conc_mar_wilcox$conf.int[1],
                                      UT5_TKN_conc_apr_wilcox$conf.int[1],
                                      UT5_TKN_conc_may_wilcox$conf.int[1],
                                      UT5_TKN_conc_jun_wilcox$conf.int[1],
                                      UT5_TKN_conc_jul_wilcox$conf.int[1],
                                      UT5_TKN_conc_aug_wilcox$conf.int[1],
                                      UT5_TKN_conc_sep_wilcox$conf.int[1]),
                           up_conf=c(UT5_TKN_conc_oct_wilcox$conf.int[2],
                                     UT5_TKN_conc_nov_wilcox$conf.int[2],
                                     UT5_TKN_conc_dec_wilcox$conf.int[2],
                                     UT5_TKN_conc_jan_wilcox$conf.int[2],
                                     UT5_TKN_conc_feb_wilcox$conf.int[2],
                                     UT5_TKN_conc_mar_wilcox$conf.int[2],
                                     UT5_TKN_conc_apr_wilcox$conf.int[2],
                                     UT5_TKN_conc_may_wilcox$conf.int[2],
                                     UT5_TKN_conc_jun_wilcox$conf.int[2],
                                     UT5_TKN_conc_jul_wilcox$conf.int[2],
                                     UT5_TKN_conc_aug_wilcox$conf.int[2],
                                     UT5_TKN_conc_sep_wilcox$conf.int[2]))

write.table(Conc_compare, "UT5_TKN_conc_wilcox.txt", quote=FALSE, row.names=FALSE)

rng <- max(abs(c(Conc_compare$up_conf, Conc_compare$low_conf)))
tiff("UT5_TKN_conc_shift_wilcox_Vert_Bars.tif", height=600, width=800, res=130)
par(mar=c(4,5,0.5,0.5))
plot(seq(1:12), Conc_compare$chng_est, typ='h', lend=1, lwd=15, col='white', xaxt='n', xlim=c(1,13), ylim=c(-rng, rng), xlab="Month", ylab=expression(paste("Median Concentration Change, mg  ",L^-1,sep='')), las=1)
plotCI(seq(1:12), Conc_compare$chng_est, ui=Conc_compare$up_conf, li=Conc_compare$low_conf, pch=16, add=TRUE)
abline(h=0)
...
early_jan_flx <- subset(early_decade_monthly_flx, month==1)
recent_jan_flx <- subset(recent_decade_monthly_flx, month==1)
UT5_TKN_flux_jan_wilcox <- wilcox.test(recent_jan_flx$FluxDay, early_jan_flx$FluxDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

early_feb_flx <- subset(early_decade_monthly_flx, month==2)
recent_feb_flx <- subset(recent_decade_monthly_flx, month==2)
UT5_TKN_flux_feb_wilcox <- wilcox.test(recent_feb_flx$FluxDay, early_feb_flx$FluxDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

early_mar_flx <- subset(early_decade_monthly_flx, month==3)
recent_mar_flx <- subset(recent_decade_monthly_flx, month==3)
UT5_TKN_flux_mar_wilcox <- wilcox.test(recent_mar_flx$FluxDay, early_mar_flx$FluxDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

early_apr_flx <- subset(early_decade_monthly_flx, month==4)
recent_apr_flx <- subset(recent_decade_monthly_flx, month==4)
UT5_TKN_flux_apr_wilcox <- wilcox.test(recent_apr_flx$FluxDay, early_apr_flx$FluxDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

early_may_flx <- subset(early_decade_monthly_flx, month==5)
recent_may_flx <- subset(recent_decade_monthly_flx, month==5)
UT5_TKN_flux_may_wilcox <- wilcox.test(recent_may_flx$FluxDay, early_may_flx$FluxDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

early_jun_flx <- subset(early_decade_monthly_flx, month==6)
recent_jun_flx <- subset(recent_decade_monthly_flx, month==6)
UT5_TKN_flux_jun_wilcox <- wilcox.test(recent_jun_flx$FluxDay, early_jun_flx$FluxDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

early_jul_flx <- subset(early_decade_monthly_flx, month==7)
recent_jul_flx <- subset(recent_decade_monthly_flx, month==7)
UT5_TKN_flux_jul_wilcox <- wilcox.test(recent_jul_flx$FluxDay, early_jul_flx$FluxDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

early_aug_flx <- subset(early_decade_monthly_flx, month==8)
recent_aug_flx <- subset(recent_decade_monthly_flx, month==8)
UT5_TKN_flux_aug_wilcox <- wilcox.test(recent_aug_flx$FluxDay, early_aug_flx$FluxDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

early_sep_flx <- subset(early_decade_monthly_flx, month==9)
recent_sep_flx <- subset(recent_decade_monthly_flx, month==9)
UT5_TKN_flux_sep_wilcox <- wilcox.test(recent_sep_flx$FluxDay, early_sep_flx$FluxDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

early_oct_flx <- subset(early_decade_monthly_flx, month==10)
recent_oct_flx <- subset(recent_decade_monthly_flx, month==10)
UT5_TKN_flux_oct_wilcox <- wilcox.test(recent_oct_flx$FluxDay, early_oct_flx$FluxDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

early_nov_flx <- subset(early_decade_monthly_flx, month==11)
recent_nov_flx <- subset(recent_decade_monthly_flx, month==11)
UT5_TKN_flux_nov_wilcox <- wilcox.test(recent_nov_flx$FluxDay, early_nov_flx$FluxDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

early_dec_flx <- subset(early_decade_monthly_flx, month==12)
recent_dec_flx <- subset(recent_decade_monthly_flx, month==12)
UT5_TKN_flux_dec_wilcox <- wilcox.test(recent_dec_flx$FluxDay, early_dec_flx$FluxDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)


Flux_compare <- data.frame(chng_est=c(UT5_TKN_flux_oct_wilcox$est,
                                      UT5_TKN_flux_nov_wilcox$est,
                                      UT5_TKN_flux_dec_wilcox$est,
                                      UT5_TKN_flux_jan_wilcox$est,
                                      UT5_TKN_flux_feb_wilcox$est,
                                      UT5_TKN_flux_mar_wilcox$est,
                                      UT5_TKN_flux_apr_wilcox$est,
                                      UT5_TKN_flux_may_wilcox$est,
                                      UT5_TKN_flux_jun_wilcox$est,
                                      UT5_TKN_flux_jul_wilcox$est,
                                      UT5_TKN_flux_aug_wilcox$est,
                                      UT5_TKN_flux_sep_wilcox$est),
                           low_conf=c(UT5_TKN_flux_oct_wilcox$conf.int[1],
                                      UT5_TKN_flux_nov_wilcox$conf.int[1],
                                      UT5_TKN_flux_dec_wilcox$conf.int[1],
                                      UT5_TKN_flux_jan_wilcox$conf.int[1],
                                      UT5_TKN_flux_feb_wilcox$conf.int[1],
                                      UT5_TKN_flux_mar_wilcox$conf.int[1],
                                      UT5_TKN_flux_apr_wilcox$conf.int[1],
                                      UT5_TKN_flux_may_wilcox$conf.int[1],
                                      UT5_TKN_flux_jun_wilcox$conf.int[1],
                                      UT5_TKN_flux_jul_wilcox$conf.int[1],
                                      UT5_TKN_flux_aug_wilcox$conf.int[1],
                                      UT5_TKN_flux_sep_wilcox$conf.int[1]),
                           up_conf=c(UT5_TKN_flux_oct_wilcox$conf.int[2],
                                     UT5_TKN_flux_nov_wilcox$conf.int[2],
                                     UT5_TKN_flux_dec_wilcox$conf.int[2],
                                     UT5_TKN_flux_jan_wilcox$conf.int[2],
                                     UT5_TKN_flux_feb_wilcox$conf.int[2],
                                     UT5_TKN_flux_mar_wilcox$conf.int[2],
                                     UT5_TKN_flux_apr_wilcox$conf.int[2],
                                     UT5_TKN_flux_may_wilcox$conf.int[2],
                                     UT5_TKN_flux_jun_wilcox$conf.int[2],
                                     UT5_TKN_flux_jul_wilcox$conf.int[2],
                                     UT5_TKN_flux_aug_wilcox$conf.int[2],
                                     UT5_TKN_flux_sep_wilcox$conf.int[2]))

write.table(Flux_compare, "UT5_TKN_flux_wilcox.txt", quote=FALSE, row.names=FALSE)

rng_flx <- max(abs(c(Flux_compare$up_conf, Flux_compare$low_conf)))
tiff("UT5_TKN_flux_shift_wilcox_Vert_Bars.tif", height=600, width=800, res=130)
par(mar=c(4,5,0.5,0.5))
plot(seq(1:12), Flux_compare$chng_est, typ='h', lend=1, lwd=15, col='white', xaxt='n', xlim=c(1,13), ylim=c(-rng_flx, rng_flx), xlab="Month", ylab=expression(paste("Median Flux Change, kg",sep='')), las=1)
plotCI(seq(1:12), Flux_compare$chng_est, ui=Flux_compare$up_conf, li=Flux_compare$low_conf, pch=16, add=TRUE)
abline(h=0)
...
tiff("UT5_Date_Discharge_TKN_conc_no_log.tif",height = 700, width = 1000, res=120)
plotConcQSmooth(eList,date1, date2, date3,qLow, qHigh, logScale=FALSE,printLegend =TRUE,legendLeft=0,legendTop=0,printTitle=TRUE)
dev.off()
...
localAnnualResults <- setupYears(paStart = paStart, paLong = paLong, localDaily = localDaily)
write.table(localAnnualResults, file = 'UT5_TP_RawVals.txt', quote=FALSE, row.names=FALSE)
...
early_jan <- subset(early_decade_monthly_mn, month==1)
recent_jan <- subset(recent_decade_monthly_mn, month==1)
UT5_TP_conc_jan_wilcox <- wilcox.test(recent_jan$ConcDay, early_jan$ConcDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

early_feb <- subset(early_decade_monthly_mn, month==2)
recent_feb <- subset(recent_decade_monthly_mn, month==2)
UT5_TP_conc_feb_wilcox <- wilcox.test(recent_feb$ConcDay, early_feb$ConcDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

early_mar <- subset(early_decade_monthly_mn, month==3)
recent_mar <- subset(recent_decade_monthly_mn, month==3)
UT5_TP_conc_mar_wilcox <- wilcox.test(recent_mar$ConcDay, early_mar$ConcDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

early_apr <- subset(early_decade_monthly_mn, month==4)
recent_apr <- subset(recent_decade_monthly_mn, month==4)
UT5_TP_conc_apr_wilcox <- wilcox.test(recent_apr$ConcDay, early_apr$ConcDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

early_may <- subset(early_decade_monthly_mn, month==5)
recent_may <- subset(recent_decade_monthly_mn, month==5)
UT5_TP_conc_may_wilcox <- wilcox.test(recent_may$ConcDay, early_may$ConcDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

early_jun <- subset(early_decade_monthly_mn, month==6)
recent_jun <- subset(recent_decade_monthly_mn, month==6)
UT5_TP_conc_jun_wilcox <- wilcox.test(recent_jun$ConcDay, early_jun$ConcDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

early_jul <- subset(early_decade_monthly_mn, month==7)
recent_jul <- subset(recent_decade_monthly_mn, month==7)
UT5_TP_conc_jul_wilcox <- wilcox.test(recent_jul$ConcDay, early_jul$ConcDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

early_aug <- subset(early_decade_monthly_mn, month==8)
recent_aug <- subset(recent_decade_monthly_mn, month==8)
UT5_TP_conc_aug_wilcox <- wilcox.test(recent_aug$ConcDay, early_aug$ConcDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

early_sep <- subset(early_decade_monthly_mn, month==9)
recent_sep <- subset(recent_decade_monthly_mn, month==9)
UT5_TP_conc_sep_wilcox <- wilcox.test(recent_sep$ConcDay, early_sep$ConcDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

early_oct <- subset(early_decade_monthly_mn, month==10)
recent_oct <- subset(recent_decade_monthly_mn, month==10)
UT5_TP_conc_oct_wilcox <- wilcox.test(recent_oct$ConcDay, early_oct$ConcDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

early_nov <- subset(early_decade_monthly_mn, month==11)
recent_nov <- subset(recent_decade_monthly_mn, month==11)
UT5_TP_conc_nov_wilcox <- wilcox.test(recent_nov$ConcDay, early_nov$ConcDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

early_dec <- subset(early_decade_monthly_mn, month==12)
recent_dec <- subset(recent_decade_monthly_mn, month==12)
UT5_TP_conc_dec_wilcox <- wilcox.test(recent_dec$ConcDay, early_dec$ConcDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

Conc_compare <- data.frame(chng_est=c(UT5_TP_conc_oct_wilcox$est,
                                      UT5_TP_conc_nov_wilcox$est,
                                      UT5_TP_conc_dec_wilcox$est,
                                      UT5_TP_conc_jan_wilcox$est,
                                      UT5_TP_conc_feb_wilcox$est,
                                      UT5_TP_conc_mar_wilcox$est,
                                      UT5_TP_conc_apr_wilcox$est,
                                      UT5_TP_conc_may_wilcox$est,
                                      UT5_TP_conc_jun_wilcox$est,
                                      UT5_TP_conc_jul_wilcox$est,
                                      UT5_TP_conc_aug_wilcox$est,
                                      UT5_TP_conc_sep_wilcox$est),
                           low_conf=c(UT5_TP_conc_oct_wilcox$conf.int[1],
                                      UT5_TP_conc_nov_wilcox$conf.int[1],
                                      UT5_TP_conc_dec_wilcox$conf.int[1],
                                      UT5_TP_conc_jan_wilcox$conf.int[1],
                                      UT5_TP_conc_feb_wilcox$conf.int[1],
                                      UT5_TP_conc_mar_wilcox$conf.int[1],
                                      UT5_TP_conc_apr_wilcox$conf.int[1],
                                      UT5_TP_conc_may_wilcox$conf.int[1],
                                      UT5_TP_conc_jun_wilcox$conf.int[1],
                                      UT5_TP_conc_jul_wilcox$conf.int[1],
                                      UT5_TP_conc_aug_wilcox$conf.int[1],
                                      UT5_TP_conc_sep_wilcox$conf.int[1]),
                           up_conf=c(UT5_TP_conc_oct_wilcox$conf.int[2],
                                     UT5_TP_conc_nov_wilcox$conf.int[2],
                                     UT5_TP_conc_dec_wilcox$conf.int[2],
                                     UT5_TP_conc_jan_wilcox$conf.int[2],
                                     UT5_TP_conc_feb_wilcox$conf.int[2],
                                     UT5_TP_conc_mar_wilcox$conf.int[2],
                                     UT5_TP_conc_apr_wilcox$conf.int[2],
                                     UT5_TP_conc_may_wilcox$conf.int[2],
                                     UT5_TP_conc_jun_wilcox$conf.int[2],
                                     UT5_TP_conc_jul_wilcox$conf.int[2],
                                     UT5_TP_conc_aug_wilcox$conf.int[2],
                                     UT5_TP_conc_sep_wilcox$conf.int[2]))

write.table(Conc_compare, "UT5_TP_conc_wilcox.txt", quote=FALSE, row.names=FALSE)

rng <- max(abs(c(Conc_compare$up_conf, Conc_compare$low_conf)))
tiff("UT5_TP_conc_shift_wilcox_Vert_Bars.tif", height=600, width=800, res=130)
par(mar=c(4,5,0.5,0.5))
plot(seq(1:12), Conc_compare$chng_est, typ='h', lend=1, lwd=15, col='white', xaxt='n', xlim=c(1,13), ylim=c(-rng, rng), xlab="Month", ylab=expression(paste("Median Concentration Change, mg  ",L^-1,sep='')), las=1)
plotCI(seq(1:12), Conc_compare$chng_est, ui=Conc_compare$up_conf, li=Conc_compare$low_conf, pch=16, add=TRUE)
abline(h=0)
...
early_jan_flx <- subset(early_decade_monthly_flx, month==1)
recent_jan_flx <- subset(recent_decade_monthly_flx, month==1)
UT5_TP_flux_jan_wilcox <- wilcox.test(recent_jan_flx$FluxDay, early_jan_flx$FluxDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

early_feb_flx <- subset(early_decade_monthly_flx, month==2)
recent_feb_flx <- subset(recent_decade_monthly_flx, month==2)
UT5_TP_flux_feb_wilcox <- wilcox.test(recent_feb_flx$FluxDay, early_feb_flx$FluxDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

early_mar_flx <- subset(early_decade_monthly_flx, month==3)
recent_mar_flx <- subset(recent_decade_monthly_flx, month==3)
UT5_TP_flux_mar_wilcox <- wilcox.test(recent_mar_flx$FluxDay, early_mar_flx$FluxDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

early_apr_flx <- subset(early_decade_monthly_flx, month==4)
recent_apr_flx <- subset(recent_decade_monthly_flx, month==4)
UT5_TP_flux_apr_wilcox <- wilcox.test(recent_apr_flx$FluxDay, early_apr_flx$FluxDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

early_may_flx <- subset(early_decade_monthly_flx, month==5)
recent_may_flx <- subset(recent_decade_monthly_flx, month==5)
UT5_TP_flux_may_wilcox <- wilcox.test(recent_may_flx$FluxDay, early_may_flx$FluxDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

early_jun_flx <- subset(early_decade_monthly_flx, month==6)
recent_jun_flx <- subset(recent_decade_monthly_flx, month==6)
UT5_TP_flux_jun_wilcox <- wilcox.test(recent_jun_flx$FluxDay, early_jun_flx$FluxDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

early_jul_flx <- subset(early_decade_monthly_flx, month==7)
recent_jul_flx <- subset(recent_decade_monthly_flx, month==7)
UT5_TP_flux_jul_wilcox <- wilcox.test(recent_jul_flx$FluxDay, early_jul_flx$FluxDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

early_aug_flx <- subset(early_decade_monthly_flx, month==8)
recent_aug_flx <- subset(recent_decade_monthly_flx, month==8)
UT5_TP_flux_aug_wilcox <- wilcox.test(recent_aug_flx$FluxDay, early_aug_flx$FluxDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

early_sep_flx <- subset(early_decade_monthly_flx, month==9)
recent_sep_flx <- subset(recent_decade_monthly_flx, month==9)
UT5_TP_flux_sep_wilcox <- wilcox.test(recent_sep_flx$FluxDay, early_sep_flx$FluxDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

early_oct_flx <- subset(early_decade_monthly_flx, month==10)
recent_oct_flx <- subset(recent_decade_monthly_flx, month==10)
UT5_TP_flux_oct_wilcox <- wilcox.test(recent_oct_flx$FluxDay, early_oct_flx$FluxDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

early_nov_flx <- subset(early_decade_monthly_flx, month==11)
recent_nov_flx <- subset(recent_decade_monthly_flx, month==11)
UT5_TP_flux_nov_wilcox <- wilcox.test(recent_nov_flx$FluxDay, early_nov_flx$FluxDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

early_dec_flx <- subset(early_decade_monthly_flx, month==12)
recent_dec_flx <- subset(recent_decade_monthly_flx, month==12)
UT5_TP_flux_dec_wilcox <- wilcox.test(recent_dec_flx$FluxDay, early_dec_flx$FluxDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)


Flux_compare <- data.frame(chng_est=c(UT5_TP_flux_oct_wilcox$est,
                                      UT5_TP_flux_nov_wilcox$est,
                                      UT5_TP_flux_dec_wilcox$est,
                                      UT5_TP_flux_jan_wilcox$est,
                                      UT5_TP_flux_feb_wilcox$est,
                                      UT5_TP_flux_mar_wilcox$est,
                                      UT5_TP_flux_apr_wilcox$est,
                                      UT5_TP_flux_may_wilcox$est,
                                      UT5_TP_flux_jun_wilcox$est,
                                      UT5_TP_flux_jul_wilcox$est,
                                      UT5_TP_flux_aug_wilcox$est,
                                      UT5_TP_flux_sep_wilcox$est),
                           low_conf=c(UT5_TP_flux_oct_wilcox$conf.int[1],
                                      UT5_TP_flux_nov_wilcox$conf.int[1],
                                      UT5_TP_flux_dec_wilcox$conf.int[1],
                                      UT5_TP_flux_jan_wilcox$conf.int[1],
                                      UT5_TP_flux_feb_wilcox$conf.int[1],
                                      UT5_TP_flux_mar_wilcox$conf.int[1],
                                      UT5_TP_flux_apr_wilcox$conf.int[1],
                                      UT5_TP_flux_may_wilcox$conf.int[1],
                                      UT5_TP_flux_jun_wilcox$conf.int[1],
                                      UT5_TP_flux_jul_wilcox$conf.int[1],
                                      UT5_TP_flux_aug_wilcox$conf.int[1],
                                      UT5_TP_flux_sep_wilcox$conf.int[1]),
                           up_conf=c(UT5_TP_flux_oct_wilcox$conf.int[2],
                                     UT5_TP_flux_nov_wilcox$conf.int[2],
                                     UT5_TP_flux_dec_wilcox$conf.int[2],
                                     UT5_TP_flux_jan_wilcox$conf.int[2],
                                     UT5_TP_flux_feb_wilcox$conf.int[2],
                                     UT5_TP_flux_mar_wilcox$conf.int[2],
                                     UT5_TP_flux_apr_wilcox$conf.int[2],
                                     UT5_TP_flux_may_wilcox$conf.int[2],
                                     UT5_TP_flux_jun_wilcox$conf.int[2],
                                     UT5_TP_flux_jul_wilcox$conf.int[2],
                                     UT5_TP_flux_aug_wilcox$conf.int[2],
                                     UT5_TP_flux_sep_wilcox$conf.int[2]))

write.table(Flux_compare, "UT5_TP_flux_wilcox.txt", quote=FALSE, row.names=FALSE)

rng_flx <- max(abs(c(Flux_compare$up_conf, Flux_compare$low_conf)))
tiff("UT5_TP_flux_shift_wilcox_Vert_Bars.tif", height=600, width=800, res=130)
par(mar=c(4,5,0.5,0.5))
plot(seq(1:12), Flux_compare$chng_est, typ='h', lend=1, lwd=15, col='white', xaxt='n', xlim=c(1,13), ylim=c(-rng_flx, rng_flx), xlab="Month", ylab=expression(paste("Median Flux Change, kg",sep='')), las=1)
plotCI(seq(1:12), Flux_compare$chng_est, ui=Flux_compare$up_conf, li=Flux_compare$low_conf, pch=16, add=TRUE)
abline(h=0)
...
tiff("UT5_Date_Discharge_TP_conc_no_log.tif",height = 700, width = 1000, res=120)
plotConcQSmooth(eList,date1, date2, date3,qLow, qHigh, logScale=FALSE,printLegend =TRUE,legendLeft=0,legendTop=0,printTitle=TRUE)
dev.off()
...
localDaily <- getDaily(eList)
localAnnualResults <- setupYears(paStart = paStart, paLong = paLong, localDaily = localDaily)
write.table(localAnnualResults, file = 'UT5_SSC_RawVals.txt', quote=FALSE, row.names=FALSE)
...
early_jan <- subset(early_decade_monthly_mn, month==1)
recent_jan <- subset(recent_decade_monthly_mn, month==1)
UT5_SSC_conc_jan_wilcox <- wilcox.test(recent_jan$ConcDay, early_jan$ConcDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

early_feb <- subset(early_decade_monthly_mn, month==2)
recent_feb <- subset(recent_decade_monthly_mn, month==2)
UT5_SSC_conc_feb_wilcox <- wilcox.test(recent_feb$ConcDay, early_feb$ConcDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

early_mar <- subset(early_decade_monthly_mn, month==3)
recent_mar <- subset(recent_decade_monthly_mn, month==3)
UT5_SSC_conc_mar_wilcox <- wilcox.test(recent_mar$ConcDay, early_mar$ConcDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

early_apr <- subset(early_decade_monthly_mn, month==4)
recent_apr <- subset(recent_decade_monthly_mn, month==4)
UT5_SSC_conc_apr_wilcox <- wilcox.test(recent_apr$ConcDay, early_apr$ConcDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

early_may <- subset(early_decade_monthly_mn, month==5)
recent_may <- subset(recent_decade_monthly_mn, month==5)
UT5_SSC_conc_may_wilcox <- wilcox.test(recent_may$ConcDay, early_may$ConcDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

early_jun <- subset(early_decade_monthly_mn, month==6)
recent_jun <- subset(recent_decade_monthly_mn, month==6)
UT5_SSC_conc_jun_wilcox <- wilcox.test(recent_jun$ConcDay, early_jun$ConcDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

early_jul <- subset(early_decade_monthly_mn, month==7)
recent_jul <- subset(recent_decade_monthly_mn, month==7)
UT5_SSC_conc_jul_wilcox <- wilcox.test(recent_jul$ConcDay, early_jul$ConcDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

early_aug <- subset(early_decade_monthly_mn, month==8)
recent_aug <- subset(recent_decade_monthly_mn, month==8)
UT5_SSC_conc_aug_wilcox <- wilcox.test(recent_aug$ConcDay, early_aug$ConcDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

early_sep <- subset(early_decade_monthly_mn, month==9)
recent_sep <- subset(recent_decade_monthly_mn, month==9)
UT5_SSC_conc_sep_wilcox <- wilcox.test(recent_sep$ConcDay, early_sep$ConcDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

early_oct <- subset(early_decade_monthly_mn, month==10)
recent_oct <- subset(recent_decade_monthly_mn, month==10)
UT5_SSC_conc_oct_wilcox <- wilcox.test(recent_oct$ConcDay, early_oct$ConcDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

early_nov <- subset(early_decade_monthly_mn, month==11)
recent_nov <- subset(recent_decade_monthly_mn, month==11)
UT5_SSC_conc_nov_wilcox <- wilcox.test(recent_nov$ConcDay, early_nov$ConcDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

early_dec <- subset(early_decade_monthly_mn, month==12)
recent_dec <- subset(recent_decade_monthly_mn, month==12)
UT5_SSC_conc_dec_wilcox <- wilcox.test(recent_dec$ConcDay, early_dec$ConcDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

Conc_compare <- data.frame(chng_est=c(UT5_SSC_conc_oct_wilcox$est,
                                      UT5_SSC_conc_nov_wilcox$est,
                                      UT5_SSC_conc_dec_wilcox$est,
                                      UT5_SSC_conc_jan_wilcox$est,
                                      UT5_SSC_conc_feb_wilcox$est,
                                      UT5_SSC_conc_mar_wilcox$est,
                                      UT5_SSC_conc_apr_wilcox$est,
                                      UT5_SSC_conc_may_wilcox$est,
                                      UT5_SSC_conc_jun_wilcox$est,
                                      UT5_SSC_conc_jul_wilcox$est,
                                      UT5_SSC_conc_aug_wilcox$est,
                                      UT5_SSC_conc_sep_wilcox$est),
                           low_conf=c(UT5_SSC_conc_oct_wilcox$conf.int[1],
                                      UT5_SSC_conc_nov_wilcox$conf.int[1],
                                      UT5_SSC_conc_dec_wilcox$conf.int[1],
                                      UT5_SSC_conc_jan_wilcox$conf.int[1],
                                      UT5_SSC_conc_feb_wilcox$conf.int[1],
                                      UT5_SSC_conc_mar_wilcox$conf.int[1],
                                      UT5_SSC_conc_apr_wilcox$conf.int[1],
                                      UT5_SSC_conc_may_wilcox$conf.int[1],
                                      UT5_SSC_conc_jun_wilcox$conf.int[1],
                                      UT5_SSC_conc_jul_wilcox$conf.int[1],
                                      UT5_SSC_conc_aug_wilcox$conf.int[1],
                                      UT5_SSC_conc_sep_wilcox$conf.int[1]),
                           up_conf=c(UT5_SSC_conc_oct_wilcox$conf.int[2],
                                     UT5_SSC_conc_nov_wilcox$conf.int[2],
                                     UT5_SSC_conc_dec_wilcox$conf.int[2],
                                     UT5_SSC_conc_jan_wilcox$conf.int[2],
                                     UT5_SSC_conc_feb_wilcox$conf.int[2],
                                     UT5_SSC_conc_mar_wilcox$conf.int[2],
                                     UT5_SSC_conc_apr_wilcox$conf.int[2],
                                     UT5_SSC_conc_may_wilcox$conf.int[2],
                                     UT5_SSC_conc_jun_wilcox$conf.int[2],
                                     UT5_SSC_conc_jul_wilcox$conf.int[2],
                                     UT5_SSC_conc_aug_wilcox$conf.int[2],
                                     UT5_SSC_conc_sep_wilcox$conf.int[2]))

write.table(Conc_compare, "UT5_SSC_conc_wilcox.txt", quote=FALSE, row.names=FALSE)

rng <- max(abs(c(Conc_compare$up_conf, Conc_compare$low_conf)))
tiff("UT5_SSC_conc_shift_wilcox_Vert_Bars.tif", height=600, width=800, res=130)
par(mar=c(4,5,0.5,0.5))
plot(seq(1:12), Conc_compare$chng_est, typ='h', lend=1, lwd=15, col='white', xaxt='n', xlim=c(1,13), ylim=c(-rng, rng), xlab="Month", ylab=expression(paste("Median Concentration Change, mg  ",L^-1,sep='')), las=1)
plotCI(seq(1:12), Conc_compare$chng_est, ui=Conc_compare$up_conf, li=Conc_compare$low_conf, pch=16, add=TRUE)
abline(h=0)
...
early_jan_flx <- subset(early_decade_monthly_flx, month==1)
recent_jan_flx <- subset(recent_decade_monthly_flx, month==1)
UT5_SSC_flux_jan_wilcox <- wilcox.test(recent_jan_flx$FluxDay, early_jan_flx$FluxDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

early_feb_flx <- subset(early_decade_monthly_flx, month==2)
recent_feb_flx <- subset(recent_decade_monthly_flx, month==2)
UT5_SSC_flux_feb_wilcox <- wilcox.test(recent_feb_flx$FluxDay, early_feb_flx$FluxDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

early_mar_flx <- subset(early_decade_monthly_flx, month==3)
recent_mar_flx <- subset(recent_decade_monthly_flx, month==3)
UT5_SSC_flux_mar_wilcox <- wilcox.test(recent_mar_flx$FluxDay, early_mar_flx$FluxDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

early_apr_flx <- subset(early_decade_monthly_flx, month==4)
recent_apr_flx <- subset(recent_decade_monthly_flx, month==4)
UT5_SSC_flux_apr_wilcox <- wilcox.test(recent_apr_flx$FluxDay, early_apr_flx$FluxDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

early_may_flx <- subset(early_decade_monthly_flx, month==5)
recent_may_flx <- subset(recent_decade_monthly_flx, month==5)
UT5_SSC_flux_may_wilcox <- wilcox.test(recent_may_flx$FluxDay, early_may_flx$FluxDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

early_jun_flx <- subset(early_decade_monthly_flx, month==6)
recent_jun_flx <- subset(recent_decade_monthly_flx, month==6)
UT5_SSC_flux_jun_wilcox <- wilcox.test(recent_jun_flx$FluxDay, early_jun_flx$FluxDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

early_jul_flx <- subset(early_decade_monthly_flx, month==7)
recent_jul_flx <- subset(recent_decade_monthly_flx, month==7)
UT5_SSC_flux_jul_wilcox <- wilcox.test(recent_jul_flx$FluxDay, early_jul_flx$FluxDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

early_aug_flx <- subset(early_decade_monthly_flx, month==8)
recent_aug_flx <- subset(recent_decade_monthly_flx, month==8)
UT5_SSC_flux_aug_wilcox <- wilcox.test(recent_aug_flx$FluxDay, early_aug_flx$FluxDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

early_sep_flx <- subset(early_decade_monthly_flx, month==9)
recent_sep_flx <- subset(recent_decade_monthly_flx, month==9)
UT5_SSC_flux_sep_wilcox <- wilcox.test(recent_sep_flx$FluxDay, early_sep_flx$FluxDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

early_oct_flx <- subset(early_decade_monthly_flx, month==10)
recent_oct_flx <- subset(recent_decade_monthly_flx, month==10)
UT5_SSC_flux_oct_wilcox <- wilcox.test(recent_oct_flx$FluxDay, early_oct_flx$FluxDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

early_nov_flx <- subset(early_decade_monthly_flx, month==11)
recent_nov_flx <- subset(recent_decade_monthly_flx, month==11)
UT5_SSC_flux_nov_wilcox <- wilcox.test(recent_nov_flx$FluxDay, early_nov_flx$FluxDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

early_dec_flx <- subset(early_decade_monthly_flx, month==12)
recent_dec_flx <- subset(recent_decade_monthly_flx, month==12)
UT5_SSC_flux_dec_wilcox <- wilcox.test(recent_dec_flx$FluxDay, early_dec_flx$FluxDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)


Flux_compare <- data.frame(chng_est=c(UT5_SSC_flux_oct_wilcox$est,
                                      UT5_SSC_flux_nov_wilcox$est,
                                      UT5_SSC_flux_dec_wilcox$est,
                                      UT5_SSC_flux_jan_wilcox$est,
                                      UT5_SSC_flux_feb_wilcox$est,
                                      UT5_SSC_flux_mar_wilcox$est,
                                      UT5_SSC_flux_apr_wilcox$est,
                                      UT5_SSC_flux_may_wilcox$est,
                                      UT5_SSC_flux_jun_wilcox$est,
                                      UT5_SSC_flux_jul_wilcox$est,
                                      UT5_SSC_flux_aug_wilcox$est,
                                      UT5_SSC_flux_sep_wilcox$est),
                           low_conf=c(UT5_SSC_flux_oct_wilcox$conf.int[1],
                                      UT5_SSC_flux_nov_wilcox$conf.int[1],
                                      UT5_SSC_flux_dec_wilcox$conf.int[1],
                                      UT5_SSC_flux_jan_wilcox$conf.int[1],
                                      UT5_SSC_flux_feb_wilcox$conf.int[1],
                                      UT5_SSC_flux_mar_wilcox$conf.int[1],
                                      UT5_SSC_flux_apr_wilcox$conf.int[1],
                                      UT5_SSC_flux_may_wilcox$conf.int[1],
                                      UT5_SSC_flux_jun_wilcox$conf.int[1],
                                      UT5_SSC_flux_jul_wilcox$conf.int[1],
                                      UT5_SSC_flux_aug_wilcox$conf.int[1],
                                      UT5_SSC_flux_sep_wilcox$conf.int[1]),
                           up_conf=c(UT5_SSC_flux_oct_wilcox$conf.int[2],
                                     UT5_SSC_flux_nov_wilcox$conf.int[2],
                                     UT5_SSC_flux_dec_wilcox$conf.int[2],
                                     UT5_SSC_flux_jan_wilcox$conf.int[2],
                                     UT5_SSC_flux_feb_wilcox$conf.int[2],
                                     UT5_SSC_flux_mar_wilcox$conf.int[2],
                                     UT5_SSC_flux_apr_wilcox$conf.int[2],
                                     UT5_SSC_flux_may_wilcox$conf.int[2],
                                     UT5_SSC_flux_jun_wilcox$conf.int[2],
                                     UT5_SSC_flux_jul_wilcox$conf.int[2],
                                     UT5_SSC_flux_aug_wilcox$conf.int[2],
                                     UT5_SSC_flux_sep_wilcox$conf.int[2]))

write.table(Flux_compare, "UT5_SSC_flux_wilcox.txt", quote=FALSE, row.names=FALSE)

rng_flx <- max(abs(c(Flux_compare$up_conf, Flux_compare$low_conf)))
tiff("UT5_SSC_flux_shift_wilcox_Vert_Bars.tif", height=600, width=800, res=130)
par(mar=c(4,5,0.5,0.5))
plot(seq(1:12), Flux_compare$chng_est, typ='h', lend=1, lwd=15, col='white', xaxt='n', xlim=c(1,13), ylim=c(-rng_flx, rng_flx), xlab="Month", ylab=expression(paste("Median Flux Change, kg",sep='')), las=1)
plotCI(seq(1:12), Flux_compare$chng_est, ui=Flux_compare$up_conf, li=Flux_compare$low_conf, pch=16, add=TRUE)
abline(h=0)
...
tiff("UT5_Date_Discharge_SSC_conc_no_log.tif",height = 700, width = 1000, res=120)
plotConcQSmooth(eList,date1, date2, date3,qLow, qHigh, logScale=FALSE,printLegend =TRUE,legendLeft=0,legendTop=0,printTitle=TRUE)
dev.off()
...
localAnnualResults <- setupYears(paStart = paStart, paLong = paLong, localDaily = localDaily)
write.table(localAnnualResults, file = 'UT5_NH3_RawVals.txt', quote=FALSE, row.names=FALSE)
...
early_jan <- subset(early_decade_monthly_mn, month==1)
recent_jan <- subset(recent_decade_monthly_mn, month==1)
UT5_NH3_conc_jan_wilcox <- wilcox.test(recent_jan$ConcDay, early_jan$ConcDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

early_feb <- subset(early_decade_monthly_mn, month==2)
recent_feb <- subset(recent_decade_monthly_mn, month==2)
UT5_NH3_conc_feb_wilcox <- wilcox.test(recent_feb$ConcDay, early_feb$ConcDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

early_mar <- subset(early_decade_monthly_mn, month==3)
recent_mar <- subset(recent_decade_monthly_mn, month==3)
UT5_NH3_conc_mar_wilcox <- wilcox.test(recent_mar$ConcDay, early_mar$ConcDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

early_apr <- subset(early_decade_monthly_mn, month==4)
recent_apr <- subset(recent_decade_monthly_mn, month==4)
UT5_NH3_conc_apr_wilcox <- wilcox.test(recent_apr$ConcDay, early_apr$ConcDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

early_may <- subset(early_decade_monthly_mn, month==5)
recent_may <- subset(recent_decade_monthly_mn, month==5)
UT5_NH3_conc_may_wilcox <- wilcox.test(recent_may$ConcDay, early_may$ConcDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

early_jun <- subset(early_decade_monthly_mn, month==6)
recent_jun <- subset(recent_decade_monthly_mn, month==6)
UT5_NH3_conc_jun_wilcox <- wilcox.test(recent_jun$ConcDay, early_jun$ConcDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

early_jul <- subset(early_decade_monthly_mn, month==7)
recent_jul <- subset(recent_decade_monthly_mn, month==7)
UT5_NH3_conc_jul_wilcox <- wilcox.test(recent_jul$ConcDay, early_jul$ConcDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

early_aug <- subset(early_decade_monthly_mn, month==8)
recent_aug <- subset(recent_decade_monthly_mn, month==8)
UT5_NH3_conc_aug_wilcox <- wilcox.test(recent_aug$ConcDay, early_aug$ConcDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

early_sep <- subset(early_decade_monthly_mn, month==9)
recent_sep <- subset(recent_decade_monthly_mn, month==9)
UT5_NH3_conc_sep_wilcox <- wilcox.test(recent_sep$ConcDay, early_sep$ConcDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

early_oct <- subset(early_decade_monthly_mn, month==10)
recent_oct <- subset(recent_decade_monthly_mn, month==10)
UT5_NH3_conc_oct_wilcox <- wilcox.test(recent_oct$ConcDay, early_oct$ConcDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

early_nov <- subset(early_decade_monthly_mn, month==11)
recent_nov <- subset(recent_decade_monthly_mn, month==11)
UT5_NH3_conc_nov_wilcox <- wilcox.test(recent_nov$ConcDay, early_nov$ConcDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

early_dec <- subset(early_decade_monthly_mn, month==12)
recent_dec <- subset(recent_decade_monthly_mn, month==12)
UT5_NH3_conc_dec_wilcox <- wilcox.test(recent_dec$ConcDay, early_dec$ConcDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

Conc_compare <- data.frame(chng_est=c(UT5_NH3_conc_oct_wilcox$est,
                                      UT5_NH3_conc_nov_wilcox$est,
                                      UT5_NH3_conc_dec_wilcox$est,
                                      UT5_NH3_conc_jan_wilcox$est,
                                      UT5_NH3_conc_feb_wilcox$est,
                                      UT5_NH3_conc_mar_wilcox$est,
                                      UT5_NH3_conc_apr_wilcox$est,
                                      UT5_NH3_conc_may_wilcox$est,
                                      UT5_NH3_conc_jun_wilcox$est,
                                      UT5_NH3_conc_jul_wilcox$est,
                                      UT5_NH3_conc_aug_wilcox$est,
                                      UT5_NH3_conc_sep_wilcox$est),
                           low_conf=c(UT5_NH3_conc_oct_wilcox$conf.int[1],
                                      UT5_NH3_conc_nov_wilcox$conf.int[1],
                                      UT5_NH3_conc_dec_wilcox$conf.int[1],
                                      UT5_NH3_conc_jan_wilcox$conf.int[1],
                                      UT5_NH3_conc_feb_wilcox$conf.int[1],
                                      UT5_NH3_conc_mar_wilcox$conf.int[1],
                                      UT5_NH3_conc_apr_wilcox$conf.int[1],
                                      UT5_NH3_conc_may_wilcox$conf.int[1],
                                      UT5_NH3_conc_jun_wilcox$conf.int[1],
                                      UT5_NH3_conc_jul_wilcox$conf.int[1],
                                      UT5_NH3_conc_aug_wilcox$conf.int[1],
                                      UT5_NH3_conc_sep_wilcox$conf.int[1]),
                           up_conf=c(UT5_NH3_conc_oct_wilcox$conf.int[2],
                                     UT5_NH3_conc_nov_wilcox$conf.int[2],
                                     UT5_NH3_conc_dec_wilcox$conf.int[2],
                                     UT5_NH3_conc_jan_wilcox$conf.int[2],
                                     UT5_NH3_conc_feb_wilcox$conf.int[2],
                                     UT5_NH3_conc_mar_wilcox$conf.int[2],
                                     UT5_NH3_conc_apr_wilcox$conf.int[2],
                                     UT5_NH3_conc_may_wilcox$conf.int[2],
                                     UT5_NH3_conc_jun_wilcox$conf.int[2],
                                     UT5_NH3_conc_jul_wilcox$conf.int[2],
                                     UT5_NH3_conc_aug_wilcox$conf.int[2],
                                     UT5_NH3_conc_sep_wilcox$conf.int[2]))

write.table(Conc_compare, "UT5_NH3_conc_wilcox.txt", quote=FALSE, row.names=FALSE)

rng <- max(abs(c(Conc_compare$up_conf, Conc_compare$low_conf)))
tiff("UT5_NH3_conc_shift_wilcox_Vert_Bars.tif", height=600, width=800, res=130)
par(mar=c(4,5,0.5,0.5))
plot(seq(1:12), Conc_compare$chng_est, typ='h', lend=1, lwd=15, col='white', xaxt='n', xlim=c(1,13), ylim=c(-rng, rng), xlab="Month", ylab=expression(paste("Median Concentration Change, mg  ",L^-1,sep='')), las=1)
plotCI(seq(1:12), Conc_compare$chng_est, ui=Conc_compare$up_conf, li=Conc_compare$low_conf, pch=16, add=TRUE)
abline(h=0)
...
early_jan_flx <- subset(early_decade_monthly_flx, month==1)
recent_jan_flx <- subset(recent_decade_monthly_flx, month==1)
UT5_NH3_flux_jan_wilcox <- wilcox.test(recent_jan_flx$FluxDay, early_jan_flx$FluxDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

early_feb_flx <- subset(early_decade_monthly_flx, month==2)
recent_feb_flx <- subset(recent_decade_monthly_flx, month==2)
UT5_NH3_flux_feb_wilcox <- wilcox.test(recent_feb_flx$FluxDay, early_feb_flx$FluxDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

early_mar_flx <- subset(early_decade_monthly_flx, month==3)
recent_mar_flx <- subset(recent_decade_monthly_flx, month==3)
UT5_NH3_flux_mar_wilcox <- wilcox.test(recent_mar_flx$FluxDay, early_mar_flx$FluxDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

early_apr_flx <- subset(early_decade_monthly_flx, month==4)
recent_apr_flx <- subset(recent_decade_monthly_flx, month==4)
UT5_NH3_flux_apr_wilcox <- wilcox.test(recent_apr_flx$FluxDay, early_apr_flx$FluxDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

early_may_flx <- subset(early_decade_monthly_flx, month==5)
recent_may_flx <- subset(recent_decade_monthly_flx, month==5)
UT5_NH3_flux_may_wilcox <- wilcox.test(recent_may_flx$FluxDay, early_may_flx$FluxDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

early_jun_flx <- subset(early_decade_monthly_flx, month==6)
recent_jun_flx <- subset(recent_decade_monthly_flx, month==6)
UT5_NH3_flux_jun_wilcox <- wilcox.test(recent_jun_flx$FluxDay, early_jun_flx$FluxDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

early_jul_flx <- subset(early_decade_monthly_flx, month==7)
recent_jul_flx <- subset(recent_decade_monthly_flx, month==7)
UT5_NH3_flux_jul_wilcox <- wilcox.test(recent_jul_flx$FluxDay, early_jul_flx$FluxDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

early_aug_flx <- subset(early_decade_monthly_flx, month==8)
recent_aug_flx <- subset(recent_decade_monthly_flx, month==8)
UT5_NH3_flux_aug_wilcox <- wilcox.test(recent_aug_flx$FluxDay, early_aug_flx$FluxDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

early_sep_flx <- subset(early_decade_monthly_flx, month==9)
recent_sep_flx <- subset(recent_decade_monthly_flx, month==9)
UT5_NH3_flux_sep_wilcox <- wilcox.test(recent_sep_flx$FluxDay, early_sep_flx$FluxDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

early_oct_flx <- subset(early_decade_monthly_flx, month==10)
recent_oct_flx <- subset(recent_decade_monthly_flx, month==10)
UT5_NH3_flux_oct_wilcox <- wilcox.test(recent_oct_flx$FluxDay, early_oct_flx$FluxDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

early_nov_flx <- subset(early_decade_monthly_flx, month==11)
recent_nov_flx <- subset(recent_decade_monthly_flx, month==11)
UT5_NH3_flux_nov_wilcox <- wilcox.test(recent_nov_flx$FluxDay, early_nov_flx$FluxDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)

early_dec_flx <- subset(early_decade_monthly_flx, month==12)
recent_dec_flx <- subset(recent_decade_monthly_flx, month==12)
UT5_NH3_flux_dec_wilcox <- wilcox.test(recent_dec_flx$FluxDay, early_dec_flx$FluxDay, exact=TRUE, conf.int = TRUE, conf.level = 0.9)


Flux_compare <- data.frame(chng_est=c(UT5_NH3_flux_oct_wilcox$est,
                                      UT5_NH3_flux_nov_wilcox$est,
                                      UT5_NH3_flux_dec_wilcox$est,
                                      UT5_NH3_flux_jan_wilcox$est,
                                      UT5_NH3_flux_feb_wilcox$est,
                                      UT5_NH3_flux_mar_wilcox$est,
                                      UT5_NH3_flux_apr_wilcox$est,
                                      UT5_NH3_flux_may_wilcox$est,
                                      UT5_NH3_flux_jun_wilcox$est,
                                      UT5_NH3_flux_jul_wilcox$est,
                                      UT5_NH3_flux_aug_wilcox$est,
                                      UT5_NH3_flux_sep_wilcox$est),
                           low_conf=c(UT5_NH3_flux_oct_wilcox$conf.int[1],
                                      UT5_NH3_flux_nov_wilcox$conf.int[1],
                                      UT5_NH3_flux_dec_wilcox$conf.int[1],
                                      UT5_NH3_flux_jan_wilcox$conf.int[1],
                                      UT5_NH3_flux_feb_wilcox$conf.int[1],
                                      UT5_NH3_flux_mar_wilcox$conf.int[1],
                                      UT5_NH3_flux_apr_wilcox$conf.int[1],
                                      UT5_NH3_flux_may_wilcox$conf.int[1],
                                      UT5_NH3_flux_jun_wilcox$conf.int[1],
                                      UT5_NH3_flux_jul_wilcox$conf.int[1],
                                      UT5_NH3_flux_aug_wilcox$conf.int[1],
                                      UT5_NH3_flux_sep_wilcox$conf.int[1]),
                           up_conf=c(UT5_NH3_flux_oct_wilcox$conf.int[2],
                                     UT5_NH3_flux_nov_wilcox$conf.int[2],
                                     UT5_NH3_flux_dec_wilcox$conf.int[2],
                                     UT5_NH3_flux_jan_wilcox$conf.int[2],
                                     UT5_NH3_flux_feb_wilcox$conf.int[2],
                                     UT5_NH3_flux_mar_wilcox$conf.int[2],
                                     UT5_NH3_flux_apr_wilcox$conf.int[2],
                                     UT5_NH3_flux_may_wilcox$conf.int[2],
                                     UT5_NH3_flux_jun_wilcox$conf.int[2],
                                     UT5_NH3_flux_jul_wilcox$conf.int[2],
                                     UT5_NH3_flux_aug_wilcox$conf.int[2],
                                     UT5_NH3_flux_sep_wilcox$conf.int[2]))

write.table(Flux_compare, "UT5_NH3_flux_wilcox.txt", quote=FALSE, row.names=FALSE)

rng_flx <- max(abs(c(Flux_compare$up_conf, Flux_compare$low_conf)))
tiff("UT5_NH3_flux_shift_wilcox_Vert_Bars.tif", height=600, width=800, res=130)
par(mar=c(4,5,0.5,0.5))
plot(seq(1:12), Flux_compare$chng_est, typ='h', lend=1, lwd=15, col='white', xaxt='n', xlim=c(1,13), ylim=c(-rng_flx, rng_flx), xlab="Month", ylab=expression(paste("Median Flux Change, kg",sep='')), las=1)
plotCI(seq(1:12), Flux_compare$chng_est, ui=Flux_compare$up_conf, li=Flux_compare$low_conf, pch=16, add=TRUE)
abline(h=0)
...
tiff("UT5_Date_Discharge_NH3_conc_no_log.tif",height = 700, width = 1000, res=120)
plotConcQSmooth(eList,date1, date2, date3,qLow, qHigh, logScale=FALSE,printLegend =TRUE,legendLeft=0,legendTop=0,printTitle=TRUE)
dev.off()
...
NH3_changepoint <- read.table ("/Users/joed/LTIMP_TA/LTIMP_TA2/EGRET/UT5/NH4/EGRET_plots/UT5_NH3_RawVals.txt",header = TRUE)
...
tiff("/Users/joed/LTIMP_TA/LTIMP_TA2/EGRET/UT5/NH4/EGRET_plots/UT5_NH3_Changepoint",height = 700, width = 1200, res=120)
